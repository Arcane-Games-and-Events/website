...
export interface Post {
  ...
  /**
   * Feedback and notes from editors
   */
  editorNotes?:
    | {
        content: {
        ...
        noteType: 'general' | 'revision' | 'feedback' | 'approved' | 'needs-work';
        /**
         * Editor who created this note
         */
        createdBy?: (number | null) | User;
        /**
         * Check this when the issue has been addressed
         */
  ...
  /**
   * Premium posts become free after 30 days
   */
  accessMode: 'Free' | 'Premium';
  /**
   * Public-facing author (from Authors collection)
   */
