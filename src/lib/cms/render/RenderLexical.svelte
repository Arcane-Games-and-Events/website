<!--
  RenderLexical — public renderer for CMS entries and lesson bodies.
  ...
  Usage:
    <RenderLexical content={entry.body} cardImages={data.cardImages} />
...
{#if !content}
	<p class="text-ink/50">No content available.</p>
{:else}
