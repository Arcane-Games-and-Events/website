							...
							<div class="flex items-start justify-between gap-4">
								...
								{#if data.additionalData?.event?.id}
									<a
										...
										class="shrink-0 inline-flex items-center gap-1.5 rounded-lg bg-white/5 border border-white/10 px-3 py-1.5 text-xs font-medium text-gray-300 hover:bg-white/10 hover:text-white transition-colors"
									>
