...
<div class="min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-gray-950">
	<div class="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:px-8">
		...
		<div class="mb-8 text-center">
			...
			<h1 class="mb-2 text-2xl font-bold text-white sm:text-3xl">Purchase Confirmed!</h1>
		...
		>
			...
			<!-- Ticket Header -->
			<div
				class="relative border-b border-white/10 bg-gradient-to-r from-blue-500/10 to-purple-500/10 px-6 py-6"
			>
				...
				<div class="grid gap-4">
					...
					{#if ticket.event?.eventDate}
						...
						>
							...
							<div>
								<p class="mb-1 text-xs tracking-wider text-gray-500 uppercase">Date & Time</p>
					...
					{#if ticket.event?.location}
						...
						>
							...
							<div>
								<p class="mb-1 text-xs tracking-wider text-gray-500 uppercase">Location</p>
					...
					{#if ticket.amountPaid}
						...
						>
							<div
								class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-green-500/10 text-green-400"
							>
								<svg
									class="h-5 w-5"
									fill="none"
							...
							<div>
								<p class="mb-1 text-xs tracking-wider text-gray-500 uppercase">Amount Paid</p>
								<p class="text-sm font-medium text-white">
									${parseFloat(ticket.amountPaid).toFixed(2)} USD
								</p>
							</div>
						</div>
					{/if}
			...
			<div class="relative border-t border-white/5 bg-white/[0.01] px-6 py-4">
				...
				>
					<span
						>Purchased on {new Date(ticket.createdAt).toLocaleDateString('en-US', {
							year: 'numeric',
							month: 'long',
							day: 'numeric'
						})}</span
		...
		<div class="mt-6 flex flex-col gap-3 sm:flex-row">
			...
			<a
				href="/"
				class="inline-flex flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-500/20 transition-all hover:from-blue-600 hover:to-purple-700"
			>
