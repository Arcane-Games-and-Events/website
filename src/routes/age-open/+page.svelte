...
<div class="min-h-screen bg-gray-950">
	...
	<section class="relative overflow-hidden py-8">
		...
		<div class="absolute inset-0">
			...
			<div
				class="absolute inset-0 hidden bg-[radial-gradient(ellipse_at_center,_rgba(3,7,18,0.95)_0%,_rgba(3,7,18,0.88)_50%,_rgba(3,7,18,0.75)_100%)] lg:block"
			></div>
			<!-- Bottom fade to content -->
			<div
				class="absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-gray-950 to-transparent"
			></div>
			<!-- Accent glow effects -->
			<div class="absolute top-1/2 left-1/4 h-64 w-64 rounded-full bg-amber-500/10 blur-3xl"></div>
			<div
				class="absolute top-1/2 right-1/4 h-64 w-64 rounded-full bg-orange-500/10 blur-3xl"
			></div>
		</div>
		...
		<div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="text-center">
				<!-- Season Badge -->
				<div
					class="mb-3 inline-flex items-center gap-2 rounded-full border border-amber-500/30 bg-amber-500/20 px-3 py-1.5 text-sm font-medium text-amber-300"
				>
				...
				<!-- Title -->
				<h1 class="mb-2 text-3xl font-bold tracking-tight text-white sm:text-4xl md:text-5xl">
					AGE Open Series
				</h1>

				<!-- Tagline -->
				<p class="mb-3 text-xl font-semibold text-white sm:text-2xl">
					Compete. Climb. <span
				...
				<!-- Description -->
				<p class="mx-auto mb-4 max-w-2xl text-sm text-gray-300 sm:text-base">
					Join the premier <span class="font-medium text-white">independent</span> Flesh and Blood
					tournament circuit.
					<span
						class="bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text font-semibold text-transparent"
						>$1,000 prize pools</span
					>,
					<span
						class="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text font-semibold text-transparent"
						>AGE Points</span
					>, and your shot at the
					<span
						class="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text font-semibold text-transparent"
						>Player's Championship</span
					>.
				</p>

				<!-- Stats -->
				<div
					class="mb-5 flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-sm sm:gap-x-3 sm:text-base"
				>
					<span
						><span
							class="bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text font-bold text-transparent"
							>$30K</span
						> <span class="text-gray-400">Prize Pool</span></span
					>
					<span class="text-gray-600">·</span>
					<span
						><span
							class="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text font-bold text-transparent"
							>24</span
						> <span class="text-gray-400">Events</span></span
					>
					<span class="text-gray-600">·</span>
					<span
						><span
							class="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text font-bold text-transparent"
							>3</span
						> <span class="text-gray-400">AGE Champions</span></span
					>
				</div>
				...
				<button
					...
					class="group inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-3 font-semibold text-white shadow-lg shadow-amber-500/25 transition-all hover:scale-105 hover:shadow-xl hover:shadow-amber-500/40"
				>
					Play in an AGE Open
					<svg
